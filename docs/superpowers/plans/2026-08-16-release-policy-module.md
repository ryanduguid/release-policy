...
- Every commit message ends with the trailer `Co-Authored-By: Claude Fable 5 <noreply@anthropic.com>` (omitted from the per-task snippets for brevity; append it verbatim).
