...
- Repositories with no release workflow (`.github`, `DrDebits`, profile) are out of scope. DrDebits (now llm-tax-guardrails) is a possible later adapter but a different artefact type.
