...
run_case "archive publication preserves draft ownership" bash "$HERE/test_publish_releases.sh"

run_case "Python publication preserves release verification" bash "$HERE/test_publish_releases.sh" python
